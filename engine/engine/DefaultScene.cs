...
namespace engine
{
    class DefaultScene : Scene
    {
        ...
        private void CreateEntities()
        {
            ...
            entity.AddComponent(new ComponentTransform(new Vector3(150, 150, -2f)));
            ...
            entity.AddComponent(new ComponentTexture("Glyphs/910.jpg"));
            //entity.AddComponent(new ComponentTexture("Assets/Textures/texture2.jpg"));
            entityManager.AddEntity(entity);
            ...
            //entity.AddComponent(new ComponentTransform(new Vector3(400, 50, 0)));
